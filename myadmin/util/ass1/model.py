...
class RNN(torch.nn.Module):
    def __init__(self, input_size, hidden_size, output_size):
        ...
        self.input_size = input_size  # characters to indices mapping
        self.hidden_size = hidden_size  # indices to characters mapping
        self.output_size = output_size  # no. of unique characters in the training data
        ...
        self.Q = torch.nn.Parameter(torch.randn(hidden_size, output_size))
        self.b_h = torch.nn.Parameter(torch.zeros(hidden_size, 1))
        self.b_h = torch.nn.Parameter(torch.zeros(hidden_size, 1))


    def forward(self, input_size, hidden_size, output_size):
        pass
    def initialize_hidden(self):

def generate_dataset(bit_size, data_size):
    x = torch.randn()
